...
This tutorial covers R's debugging tools, as well as strategies and tools for catching and avoiding errors. A [screencast](https://youtu.be/-yy_3htRHdU) that demonstrates the use of R's interactive debugging tools on a specific example accompanies this document. 
...
## 2.6) Debugging R6 and ReferenceClass methods
