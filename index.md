...
(<https://github.com/berkeley-scf/tutorial-R-debugging>). If you’re
familiar with Git, you can download the files by doing a git clone from
...
next line, ‘f’ to finish executing the entire current function or
current loop, ‘c’ to continue to any subsequent browser calls, or ‘Q’ to
stop debugging. We’ll see this in the screencast demo.
...
languages.
  ...
  - R (usually helpfully) drops matrix and array dimensions that are
    ...
    object of a certain dimension. More on this in Section 4.3
...
general if you have an error, others have already posted about it.
  ...
  - [Stack Overflow](https://stackoverflow.com): R stuff will be tagged
    with ‘R’: <https://stackoverflow.com/questions/tagged/r>
...
including the output and error message. The [reprex
package](https://reprex.tidyverse.org) can help you prepare a
reproducible example to post on a mailing list.

Say what version of R, what operating system and what operating system
version you’re using. Both *sessionInfo* and *Sys.info* can be helpful
